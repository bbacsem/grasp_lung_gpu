function grad = FilterGradient(input_img, wu, lambda, y,coilsen, nsamps, nviews, kerneldistance, xyz_index, index_smth2, win_3d)
% L2grad
...
recon = FilterMFGridding(diff_kspace, wu,coilsen, kerneldistance, xyz_index, matrixsize, index_smth2, win_3d);
L2grad = 2.*recon;
